...
<x-card class="p-10 max-w-lg mx-auto mt-24">
    <header class="text-center">
        ...
        <p class="mb-4">Posst a Job to find an Artisan</p>
    </header>
    ...
    <form action="/listings" method="POST">
        ...
        <div class="mb-6">
            <label for="tag" class="inline-block text-lg mb-2">Tags (Comma Separated)</label>
            <input type="text" class="border border-gray-200 rounded p-2 w-full" value="{{old('tag')}}" name="tag">
            @error('tag')
                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
            @enderror
        </div>
